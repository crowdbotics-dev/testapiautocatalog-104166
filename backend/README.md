...
## Project Structure
    ...
    ├── testapiautocatalog_104166  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_104166`
...
2. Clone this repo and `cd testapiautocatalog_104166`
